...
const de: Translations = {
  ...
  'onboarding.llmHint': 'Wähle einen Provider oder trage deine Endpunktdaten manuell ein. Lokale Endpunkte (localhost/127.0.0.1) benötigen keinen API Key.',
...
const en: Translations = {
  ...
  'onboarding.llmHint': 'Choose a provider or enter your endpoint data manually. Local endpoints (localhost/127.0.0.1) do not require an API key.',
