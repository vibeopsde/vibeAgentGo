...
const de: Translations = {
  ...
  'explorer.newFilePrompt': 'Name der neuen Datei (z. B. notes.md oder mein-ordner/notes.md):',
...
const en: Translations = {
  ...
  'explorer.newFilePrompt': 'New file name (e.g. notes.md or my-folder/notes.md):',
